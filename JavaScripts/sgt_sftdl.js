/* PRONALAZAK TAČNE RIJEČI DIJAGONALNO DOLJE-LIJEVO */



function wordSearchFromTableDownLeft()
{
...
for (var i=matrix_height-c_len; i>=0; i--)
{
for (var j=matrix_width-1; j>=c_len-1; j--)
{
if (jump_k>jump_step-c_len)
{
